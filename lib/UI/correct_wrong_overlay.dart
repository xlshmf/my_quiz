          ...
          children: <Widget>[
            new Container(
              ...
              child: new Transform.rotate(
                ...
                child: new Icon(widget._isCorrect ? Icons.done : Icons.clear, size:_iconAnimation.value * 100,),
              ),
            ),
            new Padding(
              padding: EdgeInsets.only(top: 20),
            ),
            new Text(widget._isCorrect ? "回答正确!" : "回答错误!", style: new TextStyle(fontSize: 30,color: Colors.white),)
          ],
        ),
      ),
    );
