...
class QuestionTextState extends State<QuestionText> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _fontSizeAnimationController = new AnimationController(duration: new Duration(seconds: 1), vsync: this);
    ...
    return new Material(
      color: Colors.white,
        child: new Padding(
          ...
          child: new Center(
            child: new Text("问题 " + widget._questionNumber.toString() + ": " + widget._question,
